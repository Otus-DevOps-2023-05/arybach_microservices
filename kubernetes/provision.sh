...
docker-machine ssh ${HOSTS[0]} "
    ...
    sudo apt-get update;
    sudo apt-get install -y --allow-downgrades docker-ce=5:19.03.14~3-0~ubuntu-focal kubelet='1.19.16-00' kubeadm='1.19.16-00' kubectl='1.19.16-00';
    ...
    sudo kubectl create -f https://docs.projectcalico.org/v3.18/manifests/tigera-operator.yaml;
    curl https://docs.projectcalico.org/v3.18/manifests/custom-resources.yaml -O;
